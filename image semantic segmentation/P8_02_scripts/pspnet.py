...
def _pspnet( n_classes , encoder ,  input_height=384, input_width=576 , trainable_base=False):
	...
	base_model = Model(img_input, f5, name='base_model')
...
def resnet50_pspnet( n_classes ,  input_height=384, input_width=576 , trainable_base=False):

	model, base_model =  _pspnet( n_classes , get_resnet50_encoder ,
					  input_height=input_height, input_width=input_width , trainable_base=trainable_base )
