...
def _unet( n_classes , encoder , l1_skip_conn=True,  input_height=416, input_width=608, trainable_base=False):

	base_model , img_input , levels = encoder( input_height=input_height ,  input_width=input_width )
	[f1 , f2 , f3 , f4 , f5] = levels 

	base_model = Model(img_input, f4)
	base_model.trainable = trainable_base

	o = base_model(img_input, training=False)
...
def vgg_unet( n_classes ,  input_height=416, input_width=608 , encoder_level=3, trainable_base=False):

	model, base_model =  _unet( n_classes , get_vgg_encoder ,  input_height=input_height, input_width=input_width, trainable_base=trainable_base  )
	model.model_name = "vgg_unet"
	return (model, base_model)


def resnet50_unet(n_classes ,  input_height=416, input_width=608 , encoder_level=3, trainable_base=False):

	model, base_model =  _unet(n_classes , get_resnet50_encoder ,  input_height=input_height, input_width=input_width, trainable_base=trainable_base)
